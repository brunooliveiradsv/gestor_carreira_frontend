...
  // Grid removido, já que usaremos Box com flexbox
  Avatar
} from "@mui/material";
import {
...
                <Box
                    ...
                    sx={{
                        ...
                        '@media (min-width:600px)': { maxWidth: 'calc(50% - 12px)' }, // 2 colunas em telas sm (gap 3 = 24px, então -12px por lado)
                        '@media (min-width:960px)': { maxWidth: 'calc(33.33% - 16px)' } // 3 colunas em telas md (gap 3 = 24px, então -16px por lado)
                    }}
                >
