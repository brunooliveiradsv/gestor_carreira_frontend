...
  const [salvandoEnquete, setSalvandoEnquete] = useState(false);
  ...
  const [enqueteParaExcluir, setEnqueteParaExcluir] = useState(null);
...
  };
  ...
  const handleFecharDialogoConfirmacaoPost = () => {
    setPostParaExcluir(null);
    setDialogoConfirmacaoPostAberto(false);
  };

  const handleConfirmarApagarPost = async () => {
...
  };
  ...
  const handleFecharDialogoConfirmacaoEnquete = () => {
    setEnqueteParaExcluir(null);
    setDialogoConfirmacaoEnqueteAberto(false);
  };

  const handleConfirmarApagarEnquete = async () => {
    if (!enqueteParaExcluir) return;
    try {
...
      />
      ...
      >
        <DialogTitle id="confirm-delete-post-title">{"Confirmar Exclusão da Publicação"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="confirm-delete-post-description">
            Tem certeza que deseja apagar esta publicação? Esta ação não poderá ser desfeita.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleFecharDialogoConfirmacaoPost}>Cancelar</Button>
          <Button onClick={handleConfirmarApagarPost} color="error" variant="contained" autoFocus>
            Excluir
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog
        ...
        aria-labelledby="confirm-delete-enquete-title"
        aria-describedby="confirm-delete-enquete-description"
      >
        <DialogTitle id="confirm-delete-enquete-title">{"Confirmar Exclusão da Enquete"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="confirm-delete-enquete-description">
            Tem certeza que deseja apagar esta enquete e todos os seus votos? Esta ação não poderá ser desfeita.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleFecharDialogoConfirmacaoEnquete}>Cancelar</Button>
          <Button onClick={handleConfirmarApagarEnquete} color="error" variant="contained" autoFocus>
            Excluir
          </Button>
        </DialogActions>
      </Dialog>
