      ...
      <Paper elevation={6} sx={{ p: { xs: 2, md: 4 }, mb: 4 }}>
        ...
        <Grid container spacing={{ xs: 2, md: 4 }} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6} md={4}>
            <Paper variant="outlined" sx={{ p: 2, display: 'flex', alignItems: 'center', height: '100%', borderColor: theme.palette.divider }}>
          ...
          <Grid item xs={12} sm={12} md={4}>
            ...
            <Paper variant="outlined" sx={{ p: 2, display: 'flex', alignItems: 'center', height: '100%', borderColor: theme.palette.divider }}>
              <Avatar sx={{ bgcolor: saldo >= 0 ? 'primary.light' : 'error.light', mr: 2 }}>
                <AccountBalanceWalletIcon sx={{ color: saldo >= 0 ? 'primary.dark' : 'error.dark' }} />
              </Avatar>
              <Box>
                <Typography color="text.secondary">Balanço (período)</Typography>
                <Typography variant="h5" fontWeight="bold" sx={{ color: saldo >= 0 ? 'primary.main' : 'error.main' }}>R$ {saldo.toFixed(2)}</Typography>
              </Box>
            </Paper>
          </Grid>
        </Grid>
          ...
          {transacoesFiltradas.length > 0 ? transacoesFiltradas.map(t => (
            ...
            <Box sx={{ p: { xs: 3, md: 5 }, textAlign: 'center', border: `2px dashed ${theme.palette.divider}`, borderRadius: 2, mt: 3 }}>
                ...
                <Typography color="text.secondary">
                    Clique em "Nova Transação" para registrar suas receitas e despesas.
                </Typography>
            </Box>
          )}
        </Box>
